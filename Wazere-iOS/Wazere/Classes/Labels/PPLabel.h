...
/**
 Tells the delegate that the label was touched and returns which character was
 touched.
 ...
 @return Return YES if the delegate handled this touch and should not be
...
/// Subclass of PPLabel which can detect touches and report which character was
/// touched.
